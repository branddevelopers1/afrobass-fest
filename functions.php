...
function fest_enqueue() {
    wp_enqueue_style('fest-main', get_template_directory_uri() . '/assets/css/main.css', [], '3.2.4');
    wp_enqueue_style('fest-style', get_stylesheet_uri(), ['fest-main'], '3.2.4');
    wp_enqueue_script('fest-main', get_template_directory_uri() . '/assets/js/main.js', [], '3.2.4', true);
